...
async function adminLogin(event) {
    ...
    try {
        ...
        const response = await fetch('68.183.247.116:3000/api/admin/login', {
            method: 'POST',
            headers: {
...
async function changePassword(event) {
  ...
  const res = await fetch('68.183.247.116:3000/api/admin/change-password', {
    method: 'POST',
    headers: {
      'Content-Type': 'application/json',
...
async function getDashboard(adminToken) {
    try {
        const response = await fetch('68.183.247.116:3000/api/admin/dashboard/overview', {
            headers: {
...
async function getOrders(adminToken) {
    try {
        const response = await fetch('68.183.247.116:3000/api/orders/admin/all', {
            headers: {
                'Authorization': `Bearer ${adminToken}`
            }
        });
...
async function onStatusChange(orderId, newStatus) {
    try {
        ...
        const response = await fetch(`68.183.247.116:3000/api/orders/${orderId}/status`, {
            method: 'PATCH',
            headers: {
                'Content-Type': 'application/json',
                'Authorization': `Bearer ${adminToken}`
...
async function getAnalytics(adminToken) {
    try {
        const response = await fetch('68.183.247.116:3000/api/orders/admin/analytics', {
            headers: {
                'Authorization': `Bearer ${adminToken}`
            }
        });
...
async function getProducts(adminToken) {
    try {
        const response = await fetch('68.183.247.116:3000/api/products/admin/all?include_inactive=true', {
            headers: {
                'Authorization': `Bearer ${adminToken}`
            }
        });
...
async function deleteProduct(id) {
    try {
        ...
        const response = await fetch(`68.183.247.116:3000/api/products/${id}`, {
            method: 'DELETE',
            headers: {
                'Content-Type': 'application/json',
                'Authorization': `Bearer ${adminToken}`
...
async function onActiveChange(productId) {
    try {
        ...
        const response = await fetch(`68.183.247.116:3000/api/products/${productId}/flip-status`, {
            method: 'PATCH',
            headers: {
                'Content-Type': 'application/json',
                'Authorization': `Bearer ${adminToken}`
...
async function createProduct(event) {
    ...
    try {
        ...
        const response = await fetch('68.183.247.116:3000/api/products', {
            method: 'POST',
            headers: {
                'Content-Type': 'application/json',
                'Authorization': `Bearer ${adminToken}`
...
async function uploadImagesToServer(productId, images) {
    try {
        ...
        const response = await fetch(`68.183.247.116:3000/api/products/${productId}/images`, {
            method: 'POST',
            headers: {
                'Content-Type': 'application/json',
                'Authorization': `Bearer ${adminToken}`
...
async function getProduct() {
    try {
        ...
        const response = await fetch(`68.183.247.116:3000/api/products/${productId}`);
...
async function editImages() {
    try {
        ...
        const deleteResponse = await fetch(`68.183.247.116:3000/api/products/${productId}/images`, {
            method: 'DELETE',
            headers: {
                'Content-Type': 'application/json',
                'Authorization': `Bearer ${adminToken}`
